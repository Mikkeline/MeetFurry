...
public class FilterFunction extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_function);
        ...
        switch (v.getId()) {
            ...
            case R.id.ApplyBtn:
                ...
                if (type == 1 && color == 1 && breed == 1 && gender == 1) {
                    ...
                    Intent intent = new Intent(FilterFunction.this, FilteredShelterPage.class);
            ...
            case R.id.CancelBtn:
                startActivity(new Intent(FilterFunction.this, shelterHomepage.class) );
                break;
        }
    }
}