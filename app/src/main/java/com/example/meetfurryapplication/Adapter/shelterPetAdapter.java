...
import com.example.meetfurryapplication.shelterPetDetails;
...
public class shelterPetAdapter extends RecyclerView.Adapter<shelterPetAdapter.shelterPetViewHolder> {
    ...
    public shelterPetAdapter(Activity context, List<Image> petList){
    ...
    @NotNull
    @Override
    public shelterPetViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.shelter_each_pet, parent, false);
        ...
        return new shelterPetViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull shelterPetViewHolder holder, int position) {
    ...
    public class shelterPetViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public shelterPetViewHolder(@NonNull @NotNull View itemView) {
            super(itemView);
            mView = itemView;
    ...
    public void setAddress(String address) {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(context, shelterPetDetails.class);

            //Pass pet name to shelterPetDetails page
